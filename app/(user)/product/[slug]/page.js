  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="section-container py-12 md:py-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16">
          ...
          <div>
            {/* Main Image */}
            <div
              className="relative aspect-square overflow-hidden bg-luxury-soft-bg mb-4 cursor-zoom-in"
          ...
          <div className="flex flex-col">
            ...
            {/* Highlights */}
            <div className="bg-luxury-soft-bg p-5 mb-8 space-y-3">
              {[
                    ...
                    {isShareOpen && (
                      ...
                      >
                        <button
                          ...
                          className="w-full flex items-center gap-3 px-4 py-3 text-sm font-sans text-luxury-black hover:bg-luxury-soft-bg hover:text-gold transition-colors"
                        >
      ...
      {relatedProducts.length > 0 && (
        <div className="bg-luxury-soft-bg py-16">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-x-4 gap-y-10">
              {recentlyViewedFiltered.map((p) => (
                <Link key={p.id} href={`/product/${p.slug}`} className="group">
                  <div className="aspect-product bg-luxury-soft-bg overflow-hidden mb-3">
                    {p.image ? (
                      <Image
                        src={p.image}
                        alt={p.name}
